...
```sql
-- Describe FeatureView structure (FeatureViews are Dynamic Tables)
DESCRIBE DYNAMIC TABLE USER_PURCHASE_FV$V1;

-- List all features across FeatureViews
-- FeatureViews follow the NAME$VERSION naming convention
SELECT 
