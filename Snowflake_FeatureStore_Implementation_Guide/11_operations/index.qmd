...
# Get specific Feature View details
fv = fs.get_feature_view(name="USER_ORDER_FV", version="V01")
...
for r in rows:
    print(r["FEATURE_VIEW"], r["FEATURE_NAME"], r["DESCRIPTION"])
```
...
This returns the lineage graph showing which source tables feed into the Feature View and which models or datasets consume it. Use this before deprecating or deleting a Feature View version to confirm there are no active consumers (see also [Chapter 04: Managing Versions](../04_feature_views/index.qmd#sec-versioning)).
...
### 4. Pin SDK Versions Across Environments {#sec-sdk-versioning}
