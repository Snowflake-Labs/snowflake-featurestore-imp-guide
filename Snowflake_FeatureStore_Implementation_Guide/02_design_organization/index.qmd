...
Even with multiple Feature Stores, the Snowsight Feature Store UI (**AI & ML → Features**) lets users switch between any tagged Feature Store schema via the dropdown and browse Feature Views, Entities, and lineage without writing code. This assists with the "cross-domain discovery" issue — teams can explore what exists across stores before creating new features. See [Chapter 11: Snowsight Feature Store UI](../11_operations/index.qmd#sec-snowsight-ui) for a visual walkthrough.
:::
