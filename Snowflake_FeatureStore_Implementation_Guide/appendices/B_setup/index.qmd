...
![Demo role hierarchy from account admin to consumer](../../_diagrams/png/dg_appendix_role_tree.png){fig-alt="Role chain ACCOUNTADMIN through FS roles to consumer"}
