...
```{mermaid}
%%| fig-cap: "Demo role hierarchy from account admin to consumer"
%%| fig-alt: "Role chain ACCOUNTADMIN through FS roles to consumer"
flowchart TD
...
See [Chapter 13: Advanced Patterns](../../13_advanced_patterns/index.qmd) for detailed CI/CD patterns.
