...
The example above covers single-FV scoring. For models that consume features from **multiple Feature Views**, or that require **point-in-time correct** inference, see [Chapter 10: Scoring Feature Views](../../10_training_inference/index.qmd#sec-scoring-fv) which covers the multi-FV pre-join pattern and orchestrated Task/Sproc alternative.
:::
