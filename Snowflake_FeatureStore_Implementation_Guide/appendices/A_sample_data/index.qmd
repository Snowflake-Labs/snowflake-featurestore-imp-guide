...
![Production vs development database subset sizes](../../_diagrams/png/dg_appendix_env_trees.png){fig-alt="Production and dev databases with sampled table row counts"}
