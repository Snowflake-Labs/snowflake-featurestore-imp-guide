...
## Pipeline Classes: scikit-learn vs Snowflake ML
...
If your team maintains a **YAML manifest** for Feature View ownership and SLAs (see [Chapter 04: Feature Views -- Ownership & SLAs](../04_feature_views/index.qmd#sec-ownership)), you can extend the same manifest to record which model consumes which Feature Views and what preprocessing is applied. This is purely a team convention for documentation and CI/CD -- Snowflake does not create or consume the file:
