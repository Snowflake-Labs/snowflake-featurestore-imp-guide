...
> 📂 **Chapter code:** [Browse companion scripts on GitHub](https://github.com/Snowflake-Labs/snowflake-featurestore-imp-guide/tree/main/Snowflake_FeatureStore_Implementation_Guide/03_entities_hierarchies/_code)
...
![Product-supplier compound key relationship](../_diagrams/png/dg_03_product_supplier.png){fig-alt="Product links to multiple supplier rows requiring compound key"}
...
![Clickstream entity relationships](../_diagrams/png/dg_03_entity_web.png){fig-alt="Visitor user household session order and product relationships"}
...
### 1. Use Descriptive Names {.unnumbered}
```python
...
### 2. Document Business Context {.unnumbered}
```python
Entity(
    name="HOUSEHOLD",
    join_keys=["HOUSEHOLD_ID"],
...
### 3. Consistent Key Naming {#sec-consistent-keys .unnumbered}
