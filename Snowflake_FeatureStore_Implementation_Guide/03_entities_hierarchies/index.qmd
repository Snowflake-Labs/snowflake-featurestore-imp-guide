...
```{mermaid}
%%| fig-cap: "Product-supplier compound key relationship"
%%| fig-alt: "Product links to multiple supplier rows requiring compound key"
flowchart LR
...
```{mermaid}
%%| fig-cap: "Clickstream entity relationships"
%%| fig-alt: "Visitor user household session order and product relationships"
flowchart TB
...
See [Chapter 11: Training & Inference](../11_training_inference/index.qmd) for spine design patterns, including multi-horizon forecasting spines.
