...
![Three-phase migration: assessment migration validation](../_diagrams/png/dg_13_migration_phases.png){fig-alt="Assessment then migration then validation phases"}
