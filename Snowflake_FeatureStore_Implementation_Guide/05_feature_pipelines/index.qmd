...
- Or use the OBJECT-bundled approach ([Chapter 12: `#sec-select-star-vs-object`](../12_advanced_patterns/index.qmd#sec-select-star-vs-object)), where the upstream VIEW definition controls exactly which features enter the bundle.
