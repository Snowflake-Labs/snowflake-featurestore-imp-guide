...
A **Feature View** is a collection of related features computed from one or more source dataframe. It defines:
...
::: {.callout-note}
## 📖 Deep Dive
See [Chapter 04: Feature Views](../04_feature_views/index.qmd) for detailed coverage of Feature View types, versioning, and lifecycle management.
:::
...
# Create Feature View with DataFrame-defined features
