...
> 📂 **Chapter code:** [Browse companion scripts on GitHub](https://github.com/Snowflake-Labs/snowflake-featurestore-imp-guide/tree/main/Snowflake_FeatureStore_Implementation_Guide/01_concepts/_code)
...
![ML data infrastructure: sources, Feature Store, and ML consumers](../_diagrams/png/dg_01_ml_infrastructure.png){fig-alt="Flow from data sources through Feature Store to ML consumers"}
...
![Spine-based feature retrieval: spine joined to multiple Feature Views](../_diagrams/png/dg_01_spine_retrieval.png){fig-alt="Spine dataframe joined to purchase and session feature views"}
...
![Snowflake Feature Store architecture overview](../_diagrams/png/dg_01_fs_architecture.png){fig-alt="Source data flows into feature views and metadata, then to training, batch, and online serving"}
...
![MIT vs MDT vs ODT decision flowchart](../_diagrams/png/dg_01_mit_decision.png){fig-alt="Decision tree for where to store transformations"}
